 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://service.liweijian.com/", wsdlLocation = "http://192.168.1.2:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://service.liweijian.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.2:8080/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service.liweijian.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.liweijian.com/", "HelloServicePort"), HelloService.class, features);
    }
