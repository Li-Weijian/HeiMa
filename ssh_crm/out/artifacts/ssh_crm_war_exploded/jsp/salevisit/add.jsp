...
<META content="MSHTML 6.00.2900.3492" name=GENERATOR>
    ...
    <link href="/js/datepicker/jquery.datepick.css" type="text/css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/datepicker/jquery.datepick.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/js/datepicker/calendar.js"></script>
...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/SaleVisitAction_save.action" method=post>
