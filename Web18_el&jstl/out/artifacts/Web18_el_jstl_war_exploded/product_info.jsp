	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index.htm">首页&nbsp;&nbsp;&gt;</a> <a href="./蔬菜分类.htm">数码电器&nbsp;&nbsp;&gt;</a>
				<a>手机</a>
			</div>
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					<div>
						<strong>${productList.pname }</strong>
					</div>
					<div
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${productList.shop_price }</strong> 参 考 价：
						<del>￥${productList.shop_price }</del>
					</div>
