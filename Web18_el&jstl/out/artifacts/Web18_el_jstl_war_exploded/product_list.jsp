...
<%@ page import="com.liweijian.domain.Product" %>
	...
	<c:forEach items="${productList}" var="product">
		<div class="col-md-2" style="height:250px">
			<a href="product_info.jsp">
				<jsp:forward page="product_info.jsp"></jsp:forward>
	...
	<%
			...
			if (productlist != null){
			    for (Product product : productlist){
			        //当不能调用write时，是因为没有关联上Tomcat。
					//File->Project structure->Modules->Dependencies 点击+号进行关联
